...
You should be familiar with HTML and CSS, as well as some terminology and the landscape of modern web frameworks like React. You should know how Tailwind works and understand what the styling means.
...
Astro introduces the concept of layouts. While these files don't have to be placed in the layouts/ folder, that's what we will do here. We are just going to start with a very basic layout that looks like this:
